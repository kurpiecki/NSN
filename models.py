    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "status": {
                ...
                "characteristics_rows_found": self.status.characteristics_rows_found,
                ...
                "exported_characteristics_rows": self.status.exported_characteristics_rows,
            },
